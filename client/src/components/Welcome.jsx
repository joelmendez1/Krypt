        ...
        <div className="flex w-full justify-center item-center">
            <div className="flex md:flex-row flex-col items-start justify-between md:p-20 py-12 px-4">
                <div className="flex flex-1 justify-start flex-col md:mr-10">
                    <h1 className="text-[40px] text-3x1 sm:text-5x1 text-white text-gradient py-1 text"> Send Crypto <br/> across the world </h1>
                    ...
                    <button className="lfex flex-row justify-center items-center my-5 bg-[#2952e2] p-3 rounded-full curser-pointer hover:bg[#2546bd]" type="button" onClick={connectWallet}>
